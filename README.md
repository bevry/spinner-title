...
<span class="badge-thanksapp"><a href="https://givethanks.app/donate/npm/spinner-title" title="Donate to this project using Thanks App"><img src="https://img.shields.io/badge/thanksapp-donate-yellow.svg" alt="Thanks App donate button" /></a></span>
<span class="badge-boostlab"><a href="https://boost-lab.app/bevry/spinner-title" title="Donate to this project using Boost Lab"><img src="https://img.shields.io/badge/boostlab-donate-yellow.svg" alt="Boost Lab donate button" /></a></span>
...
<ul><li><code>spinner-title</code> aliases <code>spinner-title/index.js</code> which uses <a href="https://editions.bevry.me" title="Editions are the best way to produce and consume packages you care about.">Editions</a> to automatically select the correct edition for the consumers environment</li>
<li><code>spinner-title/source/index.js</code> is esnext source code with require for modules</li>
<li><code>spinner-title/edition-node-0.10/index.js</code> is esnext compiled for node.js 0.10 with require for modules</li></ul>
